...
const CONFIG = {
  ...
  // 系数 a:b:c 守 算力:影响力:网络 的"对分贡献",并经模拟反解让满分落1000+命中档位比例
  // 2026-06-24 结局分布平衡: 系数整体下压(峰左移,缓解资深超额), 当前比例 算力:影响力:网络≈2.2:2.5:1
  scoreCoef: { a: 0.192, b: 0.227, c: 0.089 },  // 算力:影响力:网络≈2.2:2.5:1, 模拟反解贴七档目标分布
